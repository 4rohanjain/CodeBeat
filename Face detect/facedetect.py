...
def issmallest(rects,smallest_bb):
    small_lenx = smallest_bb[2] - smallest_bb[0]
    small_leny = smallest_bb[3] - smallest_bb[1]
    for x1 , y1, x2, y2 in rects:
        if x2-x1 <= small_lenx & y2-y1 <= small_leny:
            smallest_bb = rects
